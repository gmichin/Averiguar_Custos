...
csv_path = r"C:\Users\win11\OneDrive\Documentos\Custos Médios\2026\Março\ev050326.csv"
...
produtos_especiais_originais = {
    '700': 21.20,  # Big bacon
    '845': 16.08, '809': 16.08, '1452': 16.08, '1428': 16.08,  # Paleta
    '1446': 13.20, '755': 13.20, '848': 13.20, '1433': 13.20, '1095': 13.20,  # Costela
    '1448': 7.91, '817': 7.91 , '849': 7.91, '1430': 7.91,  # Lingua
    '846': 17.90, '878': 17.90, '1432': 17.90, '1451': 17.90,  # Lombo  
    '1426': 3.68, '1447': 3.68, '850': 3.68, '746': 3.68,  # Orelha
    '1427': 2.52, '836': 2.52, '852': 2.52, '1450': 2.52,  # Pé
    '1425': 9.84, '750': 9.84,  # Ponta
    '851': 13.17, '1449': 13.17, '1429': 13.17, '748': 13.17  # Rabo
}
...
produtos_verificar_nao_encontrados = {
    ...
    '1179': 17, '1673': 25.7, '1546': 10.33, '2030': 6, '2083': 15.9,

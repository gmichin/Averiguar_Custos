...
csv_path = r"C:\Users\win11\OneDrive\Documentos\Custos Médios\2025\Setembro\ev120925.csv"
...
produtos_especiais_originais = {
    ...
    '700': 24.41, 
    # Paleta
    '845': 15.75, '809': 15.75, '1452': 15.75, 
    # Costela
    '1446': 13.81, '755': 13.81, '848': 13.81, '1433': 13.81, '1095': 13.81,
    # Lingua
    '1448': 7.88, '817': 7.88, '849': 7.88, '1430': 7.88, 
    # Lombo
    '846': 17.51, '878': 17.51, '1432': 17.51, '1451': 17.51, 
    # Orelha
    '1426': 5.13, '1447': 5.13, '850': 5.13, '746': 5.13,
    # Pé
    '1427': 3.66, '836': 3.66, '852': 3.66, '1450': 3.66, 
    # Ponta
    '1425': 9.82, '750': 9.82, 
    # Rabo
    '851': 15.81, '1449': 15.81, '1429': 15.81, '748': 15.81
}
...
produtos_verificar_nao_encontrados = {
    ...
    '1856': 12, '1720': 24.33, '1428': 18.33, '1817': 13, 
    ...
    '1106': 9.34, '1105': 9.72, '1827': 8.98, '1407': 6, '1503': 39.70,
    '1434': 16, '1444': 20, '1335':20.5, '1218': 30.5, '703': 16.87,
    '902':  9.9, '1927': 51.30, '1265': 26.30, '8001': 32.5, '8003': 29,
    '8002': 31, '8004': 9.98, '811': 11.43, '8000': 31.50
}

...
csv_path = r"C:\Users\win11\OneDrive\Documentos\Custos Médios\2026\Fevereiro\ev160226.csv"
...
produtos_especiais_originais = {
    ...
    '1446': 13.26, '755': 12.32, '848': 13.26, '1433': 13.26, '1095': 14.9,  # Costela
    '1448': 7.89, '817': 7.24 , '849': 7.86, '1430': 7.89,  # Lingua
    '846': 17.81, '878': 15.55, '1432': 17.81, '1451': 17.81,  # Lombo  
    '1426': 3.68, '1447': 3.68, '850': 3.68, '746': 3.75,  # Orelha
    '1427': 2.77, '836': 2.37, '852': 2.77, '1450': 2.77,  # Pé
    '1425': 9.76, '750': 9.76,  # Ponta
    '851': 13.85, '1449': 13.85, '1429': 13.85, '748': 12.89  # Rabo
}
...
produtos_verificar_nao_encontrados = {
    ...
    '1826': 24.98, '1759': 10, '1496': 35.9, '1909': 19, '2054': 5.17,

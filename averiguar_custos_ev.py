...
csv_path = r"C:\Users\win11\OneDrive\Documentos\Custos Médios\2026\Janeiro\ev290126.csv"
...
produtos_especiais_originais = {
    ...
    '1446': 14.10, '755': 13.06, '848': 12.4, '1433': 14.10, '1095': 13.95,  # Costela
    '1448': 7.9, '817': 6.96 , '849': 7.86, '1430': 7.9,  # Lingua
    '846': 17.01, '878': 16.5, '1432': 17.91, '1451': 17.91,  # Lombo  
    '1426': 4.05, '1447': 4.05, '850': 3.81, '746': 3.69,  # Orelha
    '1427': 2.93, '836': 2.1, '852': 2.38, '1450': 2.93,  # Pé
    '1425': 9.68, '750': 8.15,  # Ponta
    '851': 12.52, '1449': 14.26, '1429': 14.26, '748': 11.50  # Rabo
}
...
produtos_verificar_nao_encontrados = {
    ...
    '1420': 14.3, '1793': 3, '1575': 11.90, '1828': 20.50, '2041': 26.78,
    '1826': 24.98, '1759': 10, '1496': 35.9, '1909': 19, '2040': 17.5,
    '1717': 8.75, '1621': 8.42, '822': 13.69, '1677': 8.15, '2042': 19.5,
